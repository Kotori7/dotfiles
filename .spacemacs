...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages
     '(2048-game a ace-jump-helm-line ace-link aggressive-indent all-the-icons
                 anaconda-mode auctex auto-compile auto-highlight-symbol
                 auto-yasnippet biblio biblio-core bibtex-completion blacken bui
                 bundler centaur-tabs centered-cursor-mode chruby citeproc
                 clean-aindent-mode closql code-cells code-review
                 column-enforce-mode company company-anaconda company-auctex
                 company-c-headers company-math company-reftex company-web
                 concurrent consult cpp-auto-include ctable cython-mode dap-mode
                 deferred define-word devdocs diminish dired-quick-sort
                 disable-mouse disaster dotenv-mode drag-stuff dumb-jump eat ebib
                 editorconfig elisp-def elisp-demos elisp-slime-nav emacsql
                 ...
                 flyspell-popup forge gh-md ghub git-link git-messenger git-modes
                 git-timemachine gitignore-templates golden-ratio google-c-style
                 google-translate haml-mode helm-ag helm-bibtex helm-c-yasnippet
                 ...
                 hungry-delete hybrid-mode impatient-mode importmagic indent-guide
                 inf-ruby inflections info+ inspector js-doc js2-mode js2-refactor
                 json-mode json-navigator json-reformat json-snatcher link-hint
                 live-py-mode livid-mode load-env-vars lorem-ipsum lsp-docker
                 lsp-latex lsp-mode lsp-origami lsp-pyright lsp-treemacs lsp-ui
                 macrostep magit magit-section markdown-mode markdown-toc
                 math-symbol-lists minitest mmt multi-line multi-term multi-vterm
                 multiple-cursors nameless nodejs-repl npm-mode open-junk-file
                 org-ref org-superstar origami overseer ox-pandoc pacmacs paradox
                 parsebib password-generator pcre2el pdf-tools pdf-view-restore
                 pip-requirements pipenv pippel poetry popwin pos-tip prettier-js
                 projectile-rails pug-mode py-isort pydoc pyenv-mode pylookup
                 pytest pythonic pyvenv queue quickrun rainbow-delimiters rake
                 rbenv request restart-emacs rjsx-mode robe rspec-mode rubocop
                 ...
                 symon tablist tagedit term-cursor terminal-here toc-org toml-mode
                 transient treemacs-evil treemacs-icons-dired treemacs-magit
                 treemacs-persp treemacs-projectile treepy typescript-mode typit
                 ...
                 web-mode wgrep which-key winum with-editor writeroom-mode
                 ws-butler xkcd xref yaml yapfify yasnippet yasnippet-snippets)))
  (custom-set-faces
